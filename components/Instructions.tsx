...
export function Instructions() {
  return (
    <Card className="bg-white/80 backdrop-blur-sm shadow-lg max-w-md mx-auto">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-start space-x-3">
          <SlidersHorizontal className="w-5 h-5 text-orange-500 mt-1 flex-shrink-0" />
          <div>
        ...
        <div className="flex items-start space-x-3">
          <Shuffle className="w-5 h-5 text-orange-500 mt-1 flex-shrink-0" />
          <div>
